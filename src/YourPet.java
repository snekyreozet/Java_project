...
public class YourPet {
    public static void show() {
        ...
        JLabel Label = new JLabel("Your pet", SwingConstants.CENTER);
        ...
        JButton dogButton = Main.Buttons.ImgButton(new ImageIcon("src/dog.png"), 325, 130, 250, 250);
        JButton rabbitButton = Main.Buttons.ImgButton(new ImageIcon("src/rabbit.png"), 550, 130, 250, 250);
